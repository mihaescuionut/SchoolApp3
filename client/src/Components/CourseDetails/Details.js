...
export default ({ crs }) => {
  ...
  let handleEnrol = async (e) => {
    ...
    if (el.textContent == "ENROL") {
      let enrol = await api.enrolCourseById(curs.id);
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-xl font-extrabold p-4 w-2/3 rounded-full text-center bg-black text-emerald-300 animate-bounce"> {stats.length == 0 ? (
